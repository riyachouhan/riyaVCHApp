...
//                            ""+constraint.toString().trim().replaceAll(" ","+")+"&location="+"22.7028438"+","+"75.8716298"+"+&radius=20000&types=geocode&sensor=true");
                    ...
                    wo.setUrl("https://maps.googleapis.com/maps/api/place/autocomplete/json?key=AIzaSyDUhpkpgOhIqchiP-IJmvMCpG3GOalBP3M&input="+constraint.toString().trim().replaceAll(" ","+")+"&location="+lat+","+lon+"+&radius=20000&types=geocode&sensor=true");
